					...
					<div className="collapse navbar-collapse" id="navbarSupportedContent">
						<ul className="navbar-nav me-auto mb-2 mb-lg-0">
							...
							<li className="nav-item d-flex gap-1">
								...
								{token ? (
									<span className="d-flex bg-warning h-50 px-1 fw-bold align-items-center rounded-5">
										{cart.length}
									</span>
								) : (
									''
						...
						<div className="auth d-flex justify-content-center gap-3 ">
							{!token ? (
								<>
									<Link className="bg-warning py-2 px-4 rounded-5 text-dark fw-bold text-decoration-none" to="/login">
										Login
									</Link>
									<Link
